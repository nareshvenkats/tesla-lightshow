...
Algunos de estos archivos son actualizados muy frecuentemente y una traducción siempre estaría atrasada, o incluso incluyen el contenido principal en Ingles de los archivos fuente, etc.
